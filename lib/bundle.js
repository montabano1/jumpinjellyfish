...
var Hero = function () {
  ...
  _createClass(Hero, [{
    ...
    value: function bounceOffJellyfish(jellyfish) {
      if (!this.isDead && jellyfish.isBouncable && this.pos[1] + this.height > jellyfish.pos[1] && this.pos[1] + this.height < jellyfish.pos[1] + 100 && this.pos[0] + 25 > jellyfish.pos[0] + 40 && this.pos[0] < jellyfish.pos[0] + 60) {
        bounce.play();
        this.vel = [0, -5];
        this.acc = [0, 0.1];
