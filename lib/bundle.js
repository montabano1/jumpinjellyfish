...
var i = 0;
var levs = [new LevelZero(canvas, ctx), new LevelOne(canvas, ctx), new LevelTwo(canvas, ctx), new LevelThree(canvas, ctx), new CongratsLevel(canvas, ctx), new BonusLevel(canvas, ctx)];
var hasDied = false;
var controls = false;
var directions = true;
var muted = false;
...
function keyPressHandler(e) {
  if (lives === 0 && e.keyCode === 13) {
    lives = 3;
    levs = [new LevelZero(canvas, ctx), new LevelOne(canvas, ctx), new LevelTwo(canvas, ctx), new LevelThree(canvas, ctx), new CongratsLevel(canvas, ctx), new BonusLevel(canvas, ctx)];
  }
