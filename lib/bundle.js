...
var BonusLevel = function () {
  ...
  _createClass(BonusLevel, [{
    ...
    value: function draw(canvas, ctx) {
      ...
      ctx.rect(320, 30, Math.max(this.boss[0].hits * 36, 0), 30);
...
var i = 0;
var levs = [new BonusLevel(canvas, ctx), new LevelZero(canvas, ctx), new LevelOne(canvas, ctx), new LevelTwo(canvas, ctx), new LevelThree(canvas, ctx), new CongratsLevel(canvas, ctx)];
var hasDied = false;
var controls = false;
var directions = true;
var muted = false;
