...
var Hero = function () {
  ...
  _createClass(Hero, [{
    ...
    value: function killedByJellyfish(jellyfish) {
      if (this.pos[0] + 20 > jellyfish.pos[0] && this.pos[0] < jellyfish.pos[0] + 80 && this.pos[1] + this.height > jellyfish.pos[1] + 100 && this.pos[1] < jellyfish.pos[1] + jellyfish.height + 40) {
