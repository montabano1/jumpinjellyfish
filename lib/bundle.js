...
var jim = new Image();
jim.src = "/Users/michaelmontalbano/Desktop/jumpinjellyfish/assets/hero.png";
var mij = new Image();
mij.src = "/Users/michaelmontalbano/Desktop/jumpinjellyfish/assets/heroback.png";
...
var Hero = function () {
  ...
  _createClass(Hero, [{
    ...
    value: function draw(ctx) {
      ctx.beginPath();
      if (this.won) {
        ctx.drawImage(jim, 193, 260, 95, 120, this.pos[0], this.pos[1], this.width, this.height);
    ...
    value: function bounceOffJellyfish(jellyfish) {
      if (!this.isDead && jellyfish.isBouncable && this.pos[1] + this.height > jellyfish.pos[1] + 3 && this.pos[1] + this.height < jellyfish.pos[1] + 80 && this.pos[0] + 25 > jellyfish.pos[0] + 40 && this.pos[0] < jellyfish.pos[0] + 60) {
        this.vel = [0, -5];
        this.acc = [0, 0.1];
    ...
    value: function killedByJellyfish(jellyfish) {
      if (this.pos[0] + 20 > jellyfish.pos[0] && this.pos[0] < jellyfish.pos[0] + 80 && this.pos[1] + this.height > jellyfish.pos[1] + 80 && this.pos[1] < jellyfish.pos[1] + jellyfish.height + 40) {
        this.isDead = true;
      }
    }
  }, {
    ...
    value: function move(canvas) {
      ...
      if (this.isDead) {
        ...
        if (this.pos[0] + this.width > canvas.width - 3 && this.pos[0] + 25 < canvas.width) {
...
var levs = [new LevelOne(canvas, ctx), new LevelZero(canvas, ctx), new LevelTwo(canvas, ctx), new LevelThree(canvas, ctx), new CongratsLevel(canvas, ctx)];
var controls = false;
var directions = true;
document.addEventListener("keypress", keyPressHandler, false);
...
var animate = function animate() {
  ...
  if (controls) {
    ...
    if (directions) {
      ...
      ctx.fillText(levs[0].directions[0], 440, 170);
...
var LevelOne = function () {
  function LevelOne(canvas, ctx) {
    ...
    this.ctx = ctx;
    this.directions = ["LEVEL 1:", "You may bounce off the top of the", "jellyfish but dont hit their stingers!"];
...
var LevelTwo = function () {
  function LevelTwo(canvas, ctx) {
    ...
    this.ctx = ctx;
    this.directions = ['LEVEL 2:', 'click on a jellyfish to freeze it in place'];
    ...
    this.jellyfish = [new Jellyfish({ pos: [340, 300], vel: [2, 2], acc: [-0.1, -0.1], width: 40, height: 40, bouncable: true }), new Jellyfish({ pos: [540, 300], vel: [2, 2], acc: [-0.1, -0.1], width: 40, height: 40, bouncable: true }), new Jellyfish({ pos: [740, 300], vel: [2, 2], acc: [-0.1, -0.1], width: 40, height: 40, bouncable: true })];
    this.hero = new Hero({ pos: [20, 100], vel: [0, 0], color: 'orange', height: 100, width: 40 });
  }
