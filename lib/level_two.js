...
class LevelTwo {
  constructor(canvas, ctx) {
    ...
    this.directions = [
      'LEVEL 2:',
      'click on a jellyfish to freeze it in place'
    ];
    this.platforms = [
    ...
    this.jellyfish = [
      new Jellyfish({ pos: [340, 300], vel: [2, 2], acc: [-0.1, -0.1], radius: 20, color: "green", bouncable: true}),
      new Jellyfish({ pos: [540, 300], vel: [2, 2], acc: [-0.1, -0.1], radius: 20, color: "red", bouncable: true}),
      new Jellyfish({ pos: [740, 300], vel: [2, 2], acc: [-0.1, -0.1], radius: 20, color: "blue", bouncable: true}),
    ];
